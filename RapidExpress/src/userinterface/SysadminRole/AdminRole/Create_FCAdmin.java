...
import static Business.UserAccount.User.Role.Dock;
 ...
 */
public class Create_FCAdmin extends javax.swing.JPanel {
    ...
    public Create_FCAdmin(JPanel container, Enterprise enterprise, EcoSystem system) {
        initComponents();
        this.enterprise = enterprise;
        this.fc=(FulfillmentCenter)enterprise;
...
//        EcoSystem.getInstance().getDeliveryDirectory().createDelivery(name, add)
        ...
        for(Organization organization : this.fc.getInboundOrgDirectory().geInboundOrganizationList()){// .getSupplyChainOrganizationList()){// getOrganizationDirectory().getOrganizationList()){
            organizationJComboBox.addItem(organization);
            orgg=organization;
            //organization.Type.
        }
        for(Organization organization : this.fc.getOutboundOrgDirectory().getOutboundOrganizationList()){// .geInboundOrganizationList()){// .getSupplyChainOrganizationList()){// getOrganizationDirectory().getOrganizationList()){
            organizationJComboBox.addItem(organization);
            orgg=organization;
            //organization.Type.
        }
    ...
    private void populateRoleComboBox(Organization organization){
        ...
        if (organization instanceof InboundOrganization) {
            ...
            else if (organization instanceof OutboundOrganization) {
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, -1, 21));
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 130, 26));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 90, -1));
        ...
        jPanel2.add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 170, 20));

        jLabel4.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Role");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 40, 20));
        ...
        jPanel2.add(roleJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 170, 20));
        ...
        jPanel2.add(lastNameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 170, 20));
        ...
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 130, 21));

        nameJTextField1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        nameJTextField1.setBorder(null);
        jPanel2.add(nameJTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 170, 20));

        jLabel15.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("First Name");
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 80, 21));

        firstNameJTextField.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        firstNameJTextField.setBorder(null);
        jPanel2.add(firstNameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 170, 20));
        ...
        add(nameSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 140, 230, 10));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, 1810, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        Employee employee = (Employee) employeeJComboBox.getSelectedItem();
 ...
 //       Enterprise ent = organization.
        ...
        //nish start
            ...
            if(role==Role.Recieve){
            UserAccount managerDel1 = system.getUserAccountDirectory().createUserAccount(firstName, lastName, userName, password, User.Role.Recieve);
            User qq = managerDel1.getUser();
            Recieve temp=((Recieve)(qq));
            temp.setFC(fc);// setVendor(vendor);
            ((InboundOrganization)organization).addRecieve(temp);// addVendorManager(temp);// addFMDeliveryManager(temp);            
        }
            else if(role==Role.Stow){
            UserAccount managerDel1 = system.getUserAccountDirectory().createUserAccount(firstName, lastName, userName, password, User.Role.Stow);
            User qq = managerDel1.getUser();
            Stow temp=((Stow)(qq));
            temp.setFC(fc);// setVendor(vendor);
            ((InboundOrganization)organization).addStow(temp);//addVendorManager(temp);// addFMDeliveryManager(temp);            
        }
            else if(role==Role.PickAndPack){
            UserAccount managerDel1 = system.getUserAccountDirectory().createUserAccount(firstName, lastName, userName, password, User.Role.PickAndPack);
            User qq = managerDel1.getUser();
            PickAndPack temp=((PickAndPack)(qq));
            temp.setFC(fc);//setVendor(vendor);
            ((OutboundOrganization)organization).addPickAndPackMen(temp);//addVendorManager(temp);// addFMDeliveryManager(temp);            
        }
            else if(role==Role.Dock){
            UserAccount managerDel1 = system.getUserAccountDirectory().createUserAccount(firstName, lastName, userName, password, User.Role.Dock);
            User qq = managerDel1.getUser();
            Dock temp=((Dock)(qq));
            temp.setFC(fc);//setVendor(vendor);
            ((OutboundOrganization)organization).addDockMen(temp);// addVendorManager(temp);// addFMDeliveryManager(temp);            
        }
//        else if(role==Role.){
